...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'templating.asset.default_package.http' => 'getTemplating_Asset_DefaultPackage_HttpService',
            'templating.asset.default_package.ssl' => 'getTemplating_Asset_DefaultPackage_SslService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'kalkandere', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/TouchBundle/Entity'))), 'TouchBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('TouchBundle' => 'TouchBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4a8d97687254f225b96c9f6c4521bf7580015941a801217dcc0062b79a15e242');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('TouchBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('TouchBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('TouchBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('TouchBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'TouchBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/own/');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard/');
        ...
        $l->add($j, array(0 => 'ROLE_MEMBER'), NULL);
        $l->add($k, array(0 => 'ROLE_LEADER'), NULL);
    ...
    {
        return $this->services['templating.asset.default_package.http'] = new \Symfony\Component\Templating\Asset\UrlPackage(array(0 => 'http://localhost/Touch/web/asset/'), NULL, '%s?%s');
    }
    ...
    {
        return $this->services['templating.asset.default_package.ssl'] = new \Symfony\Component\Templating\Asset\UrlPackage(array(0 => 'https://localhost/Touch/web/asset/'), NULL, '%s?%s');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/TouchBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/TouchBundle/Resources/views'), 'Touch');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_LEADER' => array(0 => 'ROLE_LEADER'), 'ROLE_MEMBER' => array(0 => 'ROLE_MEMBER'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_SUPER_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TouchBundle' => 'TouchBundle\\TouchBundle',
            ...
            'fos_user.model.user.class' => 'TouchBundle\\Entity\\User',
