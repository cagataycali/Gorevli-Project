 ...
 */
class User extends \TouchBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'TouchBundle\\Entity\\User' . "\0" . 'grup', '' . "\0" . 'TouchBundle\\Entity\\User' . "\0" . 'announcement', '' . "\0" . 'TouchBundle\\Entity\\User' . "\0" . 'message', '' . "\0" . 'TouchBundle\\Entity\\User' . "\0" . 'to', '' . "\0" . 'TouchBundle\\Entity\\User' . "\0" . 'member', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addGrup(\TouchBundle\Entity\grup $grup)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGrup', array($grup));

        return parent::addGrup($grup);
    }
    ...
    public function removeGrup(\TouchBundle\Entity\grup $grup)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeGrup', array($grup));

        return parent::removeGrup($grup);
    }
    ...
    public function getGrup()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGrup', array());

        return parent::getGrup();
    }
    ...
    public function addTo(\TouchBundle\Entity\message $to)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTo', array($to));

        return parent::addTo($to);
    }
    ...
    public function removeTo(\TouchBundle\Entity\message $to)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTo', array($to));

        return parent::removeTo($to);
    }
